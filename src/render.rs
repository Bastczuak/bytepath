// use crate::{components::{LineParticle, Position, Sprite}, Gl, resources::{Flash, Shake}};
// use sdl2::{
...
use crate::{color::ColorGl, gl, gl::Gl};

pub fn render_gl(gl: &Gl, clear_color: ColorGl) -> Result<(), String> {
  unsafe {
